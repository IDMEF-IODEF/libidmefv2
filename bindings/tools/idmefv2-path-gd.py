...
def handle_alert(idmefv2):      
       ...
       classificationtext = idmefv2.Get("alert.classification.text")
...
#        value = idmefv2.Get("alert.classification.ident")
#        if value:
#               print value

#        value = idmefv2.Get("alert.source(0).ident")
#        if value:
#               print value
...
#        value = idmefv2.Get("alert.classification.reference(0).origin")
#        if value:
#               print value

#        value = idmefv2.Get("alert.classification.reference(0).name")
#        if value:
#               print value

       severity = idmefv2.Get("alert.assessment.impact.severity")
       if severity:
