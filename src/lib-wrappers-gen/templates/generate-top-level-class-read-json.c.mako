...
% else:
                        ...
                        switch(type) {
                                case ${name_lib.upper()}_ADDITIONAL_DATA_TYPE_REAL: {
                                        float val;
                                ...
                                case ${name_lib.upper()}_ADDITIONAL_DATA_TYPE_BYTE:
                                case ${name_lib.upper()}_ADDITIONAL_DATA_TYPE_BOOLEAN:
                                case ${name_lib.upper()}_ADDITIONAL_DATA_TYPE_INTEGER: {
                                        int64_t val;
                                ...
                                case ${name_lib.upper()}_ADDITIONAL_DATA_TYPE_DATE_TIME: {
                                        ${name_lib}_time_t *time;
                                        char buf[128];
                                ...
                                case ${name_lib.upper()}_ADDITIONAL_DATA_TYPE_STRING:
                                case ${name_lib.upper()}_ADDITIONAL_DATA_TYPE_BYTE_STRING:
                                case ${name_lib.upper()}_ADDITIONAL_DATA_TYPE_CHARACTER:
                                case ${name_lib.upper()}_ADDITIONAL_DATA_TYPE_NTPSTAMP:
                                case ${name_lib.upper()}_ADDITIONAL_DATA_TYPE_PORTLIST:
                                case ${name_lib.upper()}_ADDITIONAL_DATA_TYPE_XML: {
                                        ${prefix}_string_t *str;
                                        ...
                                        if ( type == ${name_lib.upper()}_ADDITIONAL_DATA_TYPE_BYTE_STRING )
                                                ret = ${name_lib}_data_set_byte_string_dup(data, (const unsigned char *) ${prefix}_string_get_string(str), ${prefix}_string_get_len(str));
                                        else
