...
static inline int ${prefix}_extract_time_safe(idmefv2_time_t **out, void *buf, size_t len, ${prefix}_msg_t *msg)
{
        int ret;
        ...
        idmefv2_time_set_sec(*out, ${prefix}_extract_uint32(buf));
        idmefv2_time_set_usec(*out, ${prefix}_extract_uint32((unsigned char *) buf + 4));
        idmefv2_time_set_gmt_offset(*out, ${prefix}_extract_int32((unsigned char *) buf + 8));

        return 0;
}


static inline int ${prefix}_extract_data_safe(idmefv2_data_t **out, void *buf, uint32_t len, ${prefix}_msg_t *msg)
{
        int ret;
        uint8_t tag;
