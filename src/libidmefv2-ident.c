...
static uint64_t get_current_time(libidmefv2_ident_t *ident)
{
        uint64_t now;
...
static void uuidgen(libidmefv2_ident_t *ident)
{
        uint64_t timestamp;
...
/**
 * libidmefv2_ident_generate:
 * @ident: Pointer to a #libidmefv2_ident_t object.
 * @out: #libidmefv2_string_t where the ident will be generated.
 *
...
int libidmefv2_ident_generate(libidmefv2_ident_t *ident, libidmefv2_string_t *out)
{
        ...
        return libidmefv2_string_sprintf(out, "%8.8x-%4.4x-%4.4x-%2.2x%2.2x",
...
/**
 * libidmefv2_ident_destroy:
 * @ident: Pointer to a #libidmefv2_ident_t object.
 *
 * Destroy a #libidmefv2_ident_t object.
 */
