...
*
* Written by Yoann Vandoorselaere <yoann@libidmefv2-ids.org>
*
*****/

#ifndef _LIBIDMEFV2_RULES_VARIABLE_H
#define _LIBIDMEFV2_RULES_VARIABLE_H
...
#endif /* _LIBIDMEFV2_RULES_VARIABLE_H */
